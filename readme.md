...
Also you'll have to download the video to watch it, for me it's showing "View raw" to download, there's also a "Raw" button and a download symbol in the top right inside the code rectangle that also works for downloading this video!  
Link:  
